...
export const LuckyLogo: React.FC<{ size?: number }> = ({ size = 24 }) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        {/* 锦鲤鸿运渐变：从头部的朱砂红过渡到尾部的黄金色 */}
        <linearGradient id={bodyGradId} x1="50%" y1="0%" x2="50%" y2="100%">
          <stop offset="0%" stopColor="#EF4444" /> {/* 头部：鲜红 */}
          <stop offset="40%" stopColor="#DC2626" /> {/* 背部：深红 */}
          <stop offset="100%" stopColor="#F59E0B" /> {/* 尾部：金色 */}
        </linearGradient>
      ...
      <g transform="translate(60, 60)" filter={`url(#${glowId})`}>
        <g transform="translate(-60, -60)">
          ...
          {/* 鱼鳞暗示 (Scales) */}
          <path d="M60 45 Q 65 50 70 45" stroke="white" strokeWidth="0.8" opacity="0.3" fill="none" />
          <path d="M50 45 Q 55 50 60 45" stroke="white" strokeWidth="0.8" opacity="0.3" fill="none" />
          <path d="M55 55 Q 60 60 65 55" stroke="white" strokeWidth="0.8" opacity="0.3" fill="none" />
          <path d="M60 65 Q 65 70 70 65" stroke="white" strokeWidth="0.8" opacity="0.2" fill="none" />
          <path d="M50 65 Q 55 70 60 65" stroke="white" strokeWidth="0.8" opacity="0.2" fill="none" />

          {/* 头部光泽 */}
          <ellipse cx="60" cy="25" rx="8" ry="4" fill="white" opacity="0.15" />
        </g>
      </g>
    </svg>
  );
